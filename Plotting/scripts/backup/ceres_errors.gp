...
plot for [j=1:1] "lhapdfGrids/lhapdf". word(PDFs,j) ."_A" . word(As, i) . ".dat" u 1:3:4 with filledcu fs transparent solid 0.3 noborder lc rgb word(colors,j) lt 3 lw 3 t "EPPS16",\
     ...
     \
     for [j=0:0] "reps/". j ."/". word(PDFs,1) ."_A". word(As, i) . ".dat" u 1:($2-$3):($2+$3) with filledcu fs transparent pattern 7 lc rgb word(colors_fit,1) lt 3 lw 3 t "nNNPDF1.0",\
     for [j=0:0] "reps/". j ."/". word(PDFs,1) ."_A". word(As, i) . ".dat" u 1:($2-$3) lt 1 lc rgb word(colors_fit,1) lw 1 with lines notitle,\
     for [j=0:0] "reps/". j ."/". word(PDFs,1) ."_A". word(As, i) . ".dat" u 1:($2+$3) lt 1 lc rgb word(colors_fit,1) lw 1 with lines notitle,\
...
plot for [j=2:2] "lhapdfGrids/lhapdf". word(PDFs,j) ."_A" . word(As, i) . ".dat" u 1:3:4 with filledcu fs transparent solid 0.5 noborder lc rgb word(colors,j) lt 3 lw 3 t "EPPS16",\
     ...
     \
     for [j=0:0] "reps/". j ."/". word(PDFs,2) ."_A". word(As, i) . ".dat" u 1:($2-$3):($2+$3) with filledcu fs transparent pattern 7 lc rgb word(colors_fit,2) lt 3 lw 3 t "nNNPDF1.0",\
     for [j=0:0] "reps/". j ."/". word(PDFs,2) ."_A". word(As, i) . ".dat" u 1:($2-$3) lt 1 lc rgb word(colors_fit,2) lw 1 with lines notitle,\
     for [j=0:0] "reps/". j ."/". word(PDFs,2) ."_A". word(As, i) . ".dat" u 1:($2+$3) lt 1 lc rgb word(colors_fit,2) lw 1 with lines notitle,\
...
plot for [j=3:3] "lhapdfGrids/lhapdf". word(PDFs,j) ."_A" . word(As, i) . ".dat" u 1:3:4 with filledcu fs transparent solid 0.3 noborder lc rgb word(colors,j) lt 3 lw 3 t "EPPS16",\
     ...
     \
     for [j=0:0] "reps/". j ."/". word(PDFs,3) ."_A". word(As, i) . ".dat" u 1:($2-$3):($2+$3) with filledcu fs transparent pattern 7 lc rgb word(colors_fit,3) lt 3 lw 3 t "nNNPDF1.0",\
     for [j=0:0] "reps/". j ."/". word(PDFs,3) ."_A". word(As, i) . ".dat" u 1:($2-$3) lt 1 lc rgb word(colors_fit,3) lw 1 with lines notitle,\
     for [j=0:0] "reps/". j ."/". word(PDFs,3) ."_A". word(As, i) . ".dat" u 1:($2+$3) lt 1 lc rgb word(colors_fit,3) lw 1 with lines notitle,\
