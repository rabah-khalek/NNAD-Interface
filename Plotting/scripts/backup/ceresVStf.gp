...
red_gradient="#E5002D #A30020 #610014"
blue_gradient="#00B9E5 #0060A5 #000766"
green_gradient="#4CE500 #27A500 #026600"
...
plot for [j=1:1] "lhapdfGrids/lhapdf". word(PDFs,j) ."_A" . word(As, i) . ".dat" u 1:3:4 with filledcu fs transparent solid 0.3 noborder lc rgb word(colors,j) lt 3 lw 3 t "EPPS16",\
     ...
     \
     "ceres/". word(PDFs,1) ."_A". word(As, i) . ".dat" u 1:($2-$3):($2+$3) with filledcu fs transparent pattern 5 lc rgb word(red_gradient,2) lt 3 lw 3 t "ceres",\
     "ceres/". word(PDFs,1) ."_A". word(As, i) . ".dat" u 1:($2-$3) lt 1 lc rgb word(red_gradient,2) lw 1 with lines notitle,\
     "ceres/". word(PDFs,1) ."_A". word(As, i) . ".dat" u 1:($2+$3) lt 1 lc rgb word(red_gradient,2) lw 1 with lines notitle,\
     "ceres/". word(PDFs,1) ."_A". word(As, i) . ".dat" u 1:2 lt 1 lc rgb word(red_gradient,2) lw 3 with lines notitle,\
     \
     "tensorflow/A". word(As, i) . ".dat" u 1:($2-$3):($2+$3) with filledcu fs transparent pattern 4 lc rgb word(red_gradient,3) lt 3 lw 3 t "TF",\
     "tensorflow/A". word(As, i) . ".dat" u 1:($2-$3) lt 1 lc rgb word(red_gradient,3) lw 1 with lines notitle,\
     "tensorflow/A". word(As, i) . ".dat" u 1:($2+$3) lt 1 lc rgb word(red_gradient,3) lw 1 with lines notitle,\
     "tensorflow/A". word(As, i) . ".dat" u 1:2 lt 1 lc rgb word(red_gradient,3) lw 3 with lines notitle,\
...
plot for [j=2:2] "lhapdfGrids/lhapdf". word(PDFs,j) ."_A" . word(As, i) . ".dat" u 1:3:4 with filledcu fs transparent solid 0.5 noborder lc rgb word(colors,j) lt 3 lw 3 t "EPPS16",\
     ...
     \
     "ceres/". word(PDFs,2) ."_A". word(As, i) . ".dat" u 1:($2-$3):($2+$3) with filledcu fs transparent pattern 5 lc rgb word(blue_gradient,2) lt 3 lw 3 t "ceres",\
     "ceres/". word(PDFs,2) ."_A". word(As, i) . ".dat" u 1:($2-$3) lt 1 lc rgb word(blue_gradient,2) lw 1 with lines notitle,\
     "ceres/". word(PDFs,2) ."_A". word(As, i) . ".dat" u 1:($2+$3) lt 1 lc rgb word(blue_gradient,2) lw 1 with lines notitle,\
     "ceres/". word(PDFs,2) ."_A". word(As, i) . ".dat" u 1:2 lt 1 lc rgb word(blue_gradient,2) lw 3 with lines notitle,\
     \
     "tensorflow/A". word(As, i) . ".dat" u 1:($4-$5):($4+$5) with filledcu fs transparent pattern 4 lc rgb word(blue_gradient,3) lt 3 lw 3 t "TF",\
     "tensorflow/A". word(As, i) . ".dat" u 1:($4-$5) lt 1 lc rgb word(blue_gradient,3) lw 1 with lines notitle,\
     "tensorflow/A". word(As, i) . ".dat" u 1:($4+$5) lt 1 lc rgb word(blue_gradient,3) lw 1 with lines notitle,\
     "tensorflow/A". word(As, i) . ".dat" u 1:4 lt 1 lc rgb word(blue_gradient,3) lw 3 with lines notitle,\
...
plot for [j=3:3] "lhapdfGrids/lhapdf". word(PDFs,j) ."_A" . word(As, i) . ".dat" u 1:3:4 with filledcu fs transparent solid 0.3 noborder lc rgb word(colors,j) lt 3 lw 3 t "EPPS16",\
     ...
     \
     "ceres/". word(PDFs,3) ."_A". word(As, i) . ".dat" u 1:($2-$3):($2+$3) with filledcu fs transparent pattern 5 lc rgb word(green_gradient,2) lt 3 lw 3 t "ceres",\
     "ceres/". word(PDFs,3) ."_A". word(As, i) . ".dat" u 1:($2-$3) lt 1 lc rgb word(green_gradient,2) lw 1 with lines notitle,\
     "ceres/". word(PDFs,3) ."_A". word(As, i) . ".dat" u 1:($2+$3) lt 1 lc rgb word(green_gradient,2) lw 1 with lines notitle,\
     "ceres/". word(PDFs,3) ."_A". word(As, i) . ".dat" u 1:2 lt 1 lc rgb word(green_gradient,2) lw 3 with lines notitle,\
     \
     "tensorflow/A". word(As, i) . ".dat" u 1:($6-$7):($6+$7) with filledcu fs transparent pattern 4 lc rgb word(green_gradient,3) lt 3 lw 3 t "TF" ,\
     "tensorflow/A". word(As, i) . ".dat" u 1:($6-$7) lt 1 lc rgb word(green_gradient,3) lw 1 with lines notitle,\
     "tensorflow/A". word(As, i) . ".dat" u 1:($6+$7) lt 1 lc rgb word(green_gradient,3) lw 1 with lines notitle,\
     "tensorflow/A". word(As, i) . ".dat" u 1:6 lt 1 lc rgb word(green_gradient,3) lw 3 with lines notitle,\
