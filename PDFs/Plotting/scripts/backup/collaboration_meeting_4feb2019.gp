...
do for [i=1:words(As)] {
outfile="figs/3.".word(indices,i)."ratiopdfplot.eps"
...
set label "A = ".word(As, i) center at 1.1,3.5 font 'Helvetica,15'
...
plot for [j=0:0] "kin_coverage/x_A". word(As, i) . ".dat" u 1:(-1):(0):(5) with vectors lw 0.05 lc rgb "red" nohead notitle,\
     for [j=2:2] "lhapdfGrids/lhapdf". word(PDFs,j) ."_A" . word(As, i) . ".dat" u 1:3:4 with filledcu fs transparent solid 0.3 noborder lc rgb word(colors,j) lt 3 lw 3 t "EPPS16",\
     for [j=2:2] "lhapdfGrids/lhapdf". word(PDFs,j) ."_A" . word(As, i) . ".dat" u 1:2 lt 8 lc rgb word(colors,j) lw 3 with lines notitle,\
     \
     for [j=0:0] "reps/". fitname ."/". j ."/". word(PDFs,2) ."_A". word(As, i) . ".dat" u 1:($2-$3):($2+$3) with filledcu fs transparent pattern 5 lc rgb word(colors_fit,2) lt 3 lw 3 t "nNNPDF1.0",\
     for [j=0:0] "reps/". fitname ."/". j ."/". word(PDFs,2) ."_A". word(As, i) . ".dat" u 1:($2-$3) lt 1 lc rgb word(colors_fit,2) lw 1 with lines notitle,\
     for [j=0:0] "reps/". fitname ."/". j ."/". word(PDFs,2) ."_A". word(As, i) . ".dat" u 1:($2+$3) lt 1 lc rgb word(colors_fit,2) lw 1 with lines notitle,\
     for [j=0:0] "reps/". fitname ."/". j ."/". word(PDFs,2) ."_A". word(As, i) . ".dat" u 1:2 lt 1 lc rgb word(colors_fit,2) lw 3 with lines notitle,\
     \
     for [j=1:reps-1] "reps/". fitname ."/". j ."/". word(PDFs,2) ."_A". word(As, i) . ".dat" u 1:2 lt 1 lc rgb word(colors_fit,2) lw 1 with lines notitle,\
...
set label  "g Ratio" center at 0.03,2.14 font 'Helvetica,15'
set label  "F_{2}^{LO} Ratio" center at 50.3,2.14 font 'Helvetica,15'
#set xlabel "x"
#set ylabel "g(x,A)"
...
plot "lhapdfGrids/lhapdfGluon_A" . word(As, i) . ".dat" u 1:($3/$2):($4/$2) with filledcu fs transparent solid 0.3 noborder lc rgb word(colors_fit,2) lt 3 lw 3 t "EPPS16",\
     "lhapdfGrids/lhapdfGluon_A" . word(As, i) . ".dat" u 1:($2/$2) lt 8 lc rgb word(colors_fit,2) lw 3 with lines notitle,\
     \
     for [j=0:0] "kin_coverage/x_A". word(As, i) . ".dat" u 1:(-1):(0):(5) with vectors lw 0.05 lc rgb "red" nohead notitle,\
     \
     for [j=0:0] "<paste reps/". fitname ."/".  j ."/Gluon_A". word(As, i) . ".dat lhapdfGrids/lhapdfGluon_A" . word(As, i) . ".dat" u 1:($2-$3)/($5):($2+$3)/($5) with filledcu fs transparent pattern 5 lc rgb word(colors_fit,2) lt 3 lw 3 t "nNNPDF1.0",\
     for [j=0:0] "<paste reps/". fitname ."/".  j ."/Gluon_A". word(As, i) . ".dat lhapdfGrids/lhapdfGluon_A" . word(As, i) . ".dat" u 1:($2-$3)/($5) lt 1 lc rgb word(colors_fit,2) lw 1 with lines notitle,\
     for [j=0:0] "<paste reps/". fitname ."/".  j ."/Gluon_A". word(As, i) . ".dat lhapdfGrids/lhapdfGluon_A" . word(As, i) . ".dat" u 1:($2+$3)/($5) lt 1 lc rgb word(colors_fit,2) lw 1 with lines notitle,\
     for [j=0:0] "<paste reps/". fitname ."/".  j ."/Gluon_A". word(As, i) . ".dat lhapdfGrids/lhapdfGluon_A" . word(As, i) . ".dat" u 1:($2)/($5) lt 1 lc rgb word(colors_fit,2) lw 3 with lines notitle,\
...
set label "Preliminary, Q_{0} = 1.3 [GeV]" center at 0.03,-0.5 tc rgb"#cccccc"
     ...
     #for [j=0:0] "kin_coverage/x_A". word(As, i) . ".dat" u 1:(3):2 with labels offset 0,char 0.6 rotate by 45
plot for [j=0:0] "kin_coverage/x_A". word(As, i) . ".dat" u 1:(-1):(0):(5) with vectors lw 0.05 lc rgb "red" nohead notitle,\
     \
     for [j=3:3] "lhapdfGrids/lhapdfSigmaT8_A" . word(As, i) . ".dat" u 1:3:4 with filledcu fs transparent solid 0.3 noborder lc rgb "#8A2BE2" lt 3 lw 3 t "EPPS16",\
     for [j=3:3] "lhapdfGrids/lhapdfSigmaT8_A" . word(As, i) . ".dat" u 1:2 lt 8 lc rgb "#8A2BE2" lw 3 with lines notitle,\
     \
     for [j=0:0] "reps/". fitname ."/". j ."/SigmaT8_A". word(As, i) . ".dat" u 1:($2-$3):($2+$3) with filledcu fs transparent pattern 5 lc rgb "#8A2BE2" lt 3 lw 3 t "nNNPDF1.0",\
     for [j=0:0] "reps/". fitname ."/". j ."/SigmaT8_A". word(As, i) . ".dat" u 1:($2-$3) lt 1 lc rgb "#8A2BE2" lw 1 with lines notitle,\
     for [j=0:0] "reps/". fitname ."/". j ."/SigmaT8_A". word(As, i) . ".dat" u 1:($2+$3) lt 1 lc rgb "#8A2BE2" lw 1 with lines notitle,\
     for [j=0:0] "reps/". fitname ."/". j ."/SigmaT8_A". word(As, i) . ".dat" u 1:2 lt 1 lc rgb "#8A2BE2" lw 3 with lines notitle,\
