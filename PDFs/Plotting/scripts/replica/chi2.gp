...
plot 0 w p ps 0.0000001 t " {/=18 SLAC}",\
     for [i=1:words(SLAC_Sets)] "Kinematics/".word(SLAC_Sets,i).".dat" u 1:($5)/($3) with p ls 5 lc rgb word(SLAC_Colors,i) t word(SLAC_Sets_names,i), \
     ...
     for [i=1:words(FNAL_Sets)] "Kinematics/".word(FNAL_Sets,i).".dat" u 1:($5)/($3) with p pt 11 lc rgb word(FNAL_Colors,i) t word(FNAL_Sets_names,i),\
     0 w p ps 0.0000001 t " ", \
     0 w p ps 0.0000001 t " {/=18 BCDMS}", \
     for [i=1:words(BCDMS_Sets)] "Kinematics/".word(BCDMS_Sets,i).".dat" u 1:($5)/($3) with p pt 11 lc rgb word(BCDMS_Colors,i) t word(BCDMS_Sets_names,i)
