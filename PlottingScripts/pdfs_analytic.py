...
if __name__ == '__main__':
    ...
    resultname = "analytic" #sys.argv[1]
    avg_dirname = 'data/PDF_grids/'+resultname+'/0/'

    gluon_path = avg_dirname+'Gluon.dat'
    sigma_path = avg_dirname+'Sigma.dat'

    ref_gluon_path = 'data/PDF_grids/ref_lhagrids/Gluon.dat'
    ref_sigma_path = 'data/PDF_grids/ref_lhagrids/Sigma.dat'
    ...
    resultpath = "results/pdfs_analytic.pdf"

    print("produced "+resultpath+" ...")
